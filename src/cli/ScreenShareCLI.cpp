...
using screenshare_runtime_internal::SavedReportContext;
using screenshare_runtime_internal::FormatSessionFingerprint;
using screenshare_runtime_internal::GenerateSessionId;
using screenshare_runtime_internal::MutableArgv;
using screenshare_runtime_internal::RemoveFileIfExists;
using screenshare_runtime_internal::ScopedCallbackLogRedirect;
using screenshare_runtime_internal::ScopedLogRedirect;
using screenshare_runtime_internal::SessionFingerprint;
using screenshare_runtime_internal::TemporaryReportLogPath;
using screenshare_runtime_internal::WriteSavedReport;
    ...
    const ScreenShareRunContext& context)
{
    ...
    return ExecuteScreenShareOptions(options, reportContext, context);
}
