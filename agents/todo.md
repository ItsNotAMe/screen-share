...
- [ ] Consume shared PeerNegotiation futures on the application signaling executor and route successful SDP through authenticated room messages. Create/apply/cancel now live in the application/proof library; the proof's old description observers have been removed.
