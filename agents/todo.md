...
- [ ] Connect automatic capture recovery to session generations and bounded retry policy. Explicit original-item WGC reconstruction and shared encoder retirement now pass: old-device frames drop without readback; fresh-device frames resume software IDR encoding. Repeated device generations still need coordinator ownership.
