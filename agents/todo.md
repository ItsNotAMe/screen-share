...
- [ ] Connect the tested peer lifecycle policy and real ICE restart path to autonomous production peer management. Preserve the rolling restart budget across reconnects; investigate reported restart timing before claiming responsive outage recovery.
