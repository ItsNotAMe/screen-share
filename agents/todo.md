...
2. Refactor the native engine into a reusable backend/core API that both the CLI and revamped UI can call directly. Keep the separate process launcher only as a fallback/diagnostic path.
