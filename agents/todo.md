...
- [ ] Finish Gate A protocol fixtures, external latency baseline and installer/distribution evidence. Content-addressed Debug/Release SDK exports, relocated SDK consumers and native portable launch now pass. Keep the unexplained earlier lifecycle failure open despite 20 debugger plus 20 normal stress cycles passing.
