...
- [ ] Finish Gate A server event schemas/fixtures, external latency baseline and installer/distribution evidence. Shared v2 client-command validation and subscription revision/generation traces now exist in native C++ and TypeScript; see refactor/ROOM-PROTOCOL.md. Content-addressed Debug/Release SDK exports, relocated SDK consumers and native portable launch pass. Keep the unexplained earlier lifecycle failure open despite 20 debugger plus 20 normal stress cycles passing.
