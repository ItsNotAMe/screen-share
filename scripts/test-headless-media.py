...
def main():
    ...
    programs = [args.build_directory.resolve() / name for name in
                ("CaptureSessionTest.exe", "CaptureDistributorTest.exe", "StreamSettingsTest.exe", "HostMediaSessionTest.exe", "IceCandidateHandoffTest.exe", "PeerConnectionLifecycleTest.exe", "WebRTCProof.exe")]
